...
java -Djetty.home=/SOLR/SolrServer/current/solr -Dsolr.solr.home=/SOLR/SolrServer/current -Dsolr.data.dir=/SOLR/data -DSTOP.PORT=8079 -DSTOP.KEY=mysecret -jar /SOLR/SolrServer/current/start.jar
